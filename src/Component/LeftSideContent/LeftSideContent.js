...
const LeftSideContent = () => {
  return (
    <div className="pl-[15px] mt-[10px] ">
      <div className="flex items-center hover:bg-[#f0f2f5] pl-[5px] py-[10px] rounded-[10px] cursor-pointer ">
        <img
          src={spiderMan}
          alt=""
      ...
      <div>
        <p className="text-[#898b8e] font-normal text-[13px]">Privacy  · Terms  · Advertising  · Ad Choices <br />  · Cookies  ·   · Meta © 2022</p>
      </div>
    </div>
  );
};
